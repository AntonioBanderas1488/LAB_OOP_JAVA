...
import java.util.Scanner; // Імпорт бібліотеки Scanner для введення даних
...
public class Main {
    ...
    public static void task3() {
        ...
        Scanner scanner = new Scanner(System.in); // Створення об'єкту Scanner для зчитування з клавіатури

        System.out.print("Введіть кількість елементів у масиві: ");
        int n = scanner.nextInt(); // Зчитування кількості елементів у масиві
        ...
        for (int i = 0; i < n; i++) {
            ...
            arr[i] = scanner.nextDouble(); // Зчитування елементів масиву з клавіатури
        }
